...
for i=SYS.IDX.redoxMat
    ...
    switch OPT.REDOX.replaceMode
        case 'replaceMass'
            ...
            MAT(i).N(SYS.IDX.redoxNuc{i})=MAT(i).N(SYS.IDX.redoxNuc{i})-dN*...
    ...
    MAT(i).N(SYS.IDX.redoxHalide{i})=MAT(i).N(SYS.IDX.redoxHalide{i})+dN*MAT(i).aFrac(SYS.IDX.redoxHalide{i});
